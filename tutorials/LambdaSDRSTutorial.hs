...
sdrs_drsref x = SDRS (M.fromList [(0, Relation (relationFromLabel "Result") 1 2),
                                  (1, Segment $ DRS [] [Rel (DRSRel "healthy") [x]]),
                                  (2, Segment $ DRS [] [Rel (DRSRel "happy") [x]])]) 2
...
sdrs_drsref_2 x y = SDRS (M.fromList [(0, Relation (relationFromLabel "Result") 1 2),
                                  (1, Segment $ DRS [] [Rel (DRSRel "healthy") [x]]),
                                  (2, Segment $ DRS [] [Rel (DRSRel "happy") [y]])]) 2

sdrs_drs d = SDRS (M.fromList [(0, Relation (relationFromLabel "Result") 1 2),
                               (1, Segment d),
                               (2, Segment $ DRS [DRSRef "x"] [Rel (DRSRel "happy") [DRSRef "x"]])]) 2

sdrs_rel r = SDRS (M.fromList [(0, Relation r 1 2),
                               (1, Segment $ DRS [DRSRef "x"] [Rel (DRSRel "healthy") [DRSRef "x"]])
                               (2, Segment $ DRS [DRSRef "x"] [Rel (DRSRel "happy") [DRSRef "x"]])])
