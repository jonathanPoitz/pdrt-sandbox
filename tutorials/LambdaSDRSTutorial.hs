...
-- without DRSRef
--sdrs_drsref x = SDRS (M.fromList [(0, CDU $ Relation (relationFromRelName "Result") 1 2),
...
--sdrs_drsref_2 x y = SDRS (M.fromList [(0, CDU $ Relation (relationFromRelName "Result") 1 2),
--                                  (1, EDU $ DRS [] [Rel (DRSRel "healthy") [x]]),
--                                  (2, EDU $ DRS [] [Rel (DRSRel "happy") [y]])]) 2

--sdrs_drs d = SDRS (M.fromList [(0, CDU $ Relation (relationFromRelName "Result") 1 2),
--                               (1, EDU d),
